...
# === 1. Carregar datasets ===
df_evolucao = pd.read_csv(r'C:\Users\josea\OneDrive\Documents\HACKATON\Apiweb\dataset\evolucao_tabela.csv')
df_evolucao['ID_PET'] = df_evolucao['Animal']

df_exames = pd.read_csv(r'C:\Users\josea\OneDrive\Documents\HACKATON\Apiweb\dataset\tabela_exames_sangue.csv')
df_exames['ID_PET'] = df_exames['ID_Arquivo']

df_dados = pd.read_excel(r'C:\Users\josea\OneDrive\Documents\HACKATON\Apiweb\dataset\dados_veterinarios.xlsx')
df_dados['ID_PET'] = df_dados['paciente']

# === 2. Carregar e tratar JSON ===
with open(r'C:\Users\josea\OneDrive\Documents\HACKATON\Apiweb\dataset\dados_veterinarios_estruturados.json', encoding='utf-8') as f:
    data = json.load(f)
...
# === 3. Merge ===
df_merge = df_evolucao.merge(df_exames, on='ID_PET', how='outer')
df_merge = df_merge.merge(df_dados, on='ID_PET', how='outer')
...
joblib.dump(label_encoders_X, 'models/label_encoders_X.pkl')
...
joblib.dump(features_treinadas, 'models/features.pkl')
...
joblib.dump(clf, 'models/modelo_desfecho.pkl')
...
joblib.dump(reg, 'models/modelo_dias.pkl')
